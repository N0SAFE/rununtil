...
program.name("run-until").description("CLI to run a task until another task is run").version("0.0.0");

program.argument("<run>", "cli task to run").argument("<until>", "cli task to run until");
